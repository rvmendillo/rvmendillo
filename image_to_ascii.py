...
def image_to_ascii():
    ...
    if input_type == 'File':
        image_to_ascii_converter = ImageToASCII(image_path, source='local', charset=list(charset), font_path=r"./static/fonts/Consolas.TTF")
    else:
        image_to_ascii_converter = ImageToASCII(image_path, source='url', charset=list(charset), font_path=r"./static/fonts/Consolas.TTF")
